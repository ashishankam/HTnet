...
def main(config):
    ...
    if (config.train):
        if not path.exists('head2_ourmodel_threedatasets_weights'):
            os.mkdir('head2_ourmodel_threedatasets_weights')
    ...
    for n_subName in subName:
        ...
        weight_path = 'head2_ourmodel_threedatasets_weights' + '/' + n_subName + '.pth'
